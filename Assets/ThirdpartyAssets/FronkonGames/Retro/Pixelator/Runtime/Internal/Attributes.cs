...
namespace FronkonGames.Retro.Pixelator
{
  ...
  /// <summary> Vector3Int with reset attribute. </summary>
  [AttributeUsage(AttributeTargets.Field)]
  public class Vector3IntWithResetAttribute : PropertyAttribute
  {
    public readonly Vector3Int value;
    public readonly string tooltip;

    public Vector3IntWithResetAttribute(int x, int y, int z, string tooltip = "")
    {
  ...
  /// <summary> Vector3Int parameter. </summary>
  [Serializable]
  public class ClampedVector3IntParameter : VolumeParameter<Vector3Int>
  {
    public Vector3Int min;
    public Vector3Int max;

    public ClampedVector3IntParameter(Vector3Int value, Vector3Int min, Vector3Int max, bool overrideState = false) : base(value, overrideState)
    {
      this.min = min;
      this.max = max;
    }
  ...
  public class GradientParameter : VolumeParameter<Gradient>
  {
    ...
    public GradientParameter() : base(new Gradient(), false) { }
  }
