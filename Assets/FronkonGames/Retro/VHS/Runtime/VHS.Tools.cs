...
namespace FronkonGames.Retro.VHS
{
  ...
  public sealed partial class VHS
  {
    ...
    private static readonly VHS[] NoEffects = new VHS[0];
        ...
        if (pipelineAsset != null)
        {
          ...
          for (int i = 0; i < scriptableRendererData.rendererFeatures.Count; ++i)
          {
            if (scriptableRendererData.rendererFeatures[i] is VHS)
              return scriptableRendererData.rendererFeatures[i] as VHS;
          }
        }
