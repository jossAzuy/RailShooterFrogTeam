...
namespace FronkonGames.Retro.Handheld8Bit
{
  ...
  public sealed partial class Handheld8Bit
  {
    ...
    private static readonly Handheld8Bit[] NoEffects = new Handheld8Bit[0];
    ...
    /// <remarks> This function use Reflection, so it can be slow. </remarks>
    public static Handheld8Bit Instance
    {
      get
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          {
            if (scriptableRendererData.rendererFeatures[i] is Handheld8Bit)
              return scriptableRendererData.rendererFeatures[i] as Handheld8Bit;
          }
        }
    ...
    /// <remarks> This function use Reflection, so it can be slow. </remarks>
    public static Handheld8Bit[] Instances
    {
      get
      {
          ...
          for (int i = 0; i < rendererDataList.Length; ++i)
          {
            if (rendererDataList[i] != null && rendererDataList[i].rendererFeatures.Count > 0)
              foreach (var feature in rendererDataList[i].rendererFeatures)
                if (feature is Handheld8Bit)
                  effects.Add(feature as Handheld8Bit);
          }
