...
namespace FronkonGames.Retro.ASCII
{
  ...
  public sealed partial class ASCII
  {
    ...
    private static readonly ASCII[] NoEffects = new ASCII[0];
    ...
    public static ASCII Instance
    {
      get
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          {
            if (scriptableRendererData.rendererFeatures[i] is ASCII)
              return scriptableRendererData.rendererFeatures[i] as ASCII;
          }
        }
