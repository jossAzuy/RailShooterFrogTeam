...
namespace FronkonGames.Retro.NTSC
{
  ...
  {
    private static readonly NTSC[] NoEffects = new NTSC[0];
    ...
    public static NTSC Instance
    {
      get
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          {
            if (scriptableRendererData.rendererFeatures[i] is NTSC)
              return scriptableRendererData.rendererFeatures[i] as NTSC;
          }
        }
