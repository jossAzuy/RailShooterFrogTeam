...
NTSC (National Television System Committee) was the analog television system used in North America and other regions from the 1950s to the early 2000s.

This effect uses a physically accurate model of the NTSC encoding/decoding process, simulating the actual analog signal modulation and demodulation to create an authentic retro TV appearance.
