...
namespace FronkonGames.Retro.LoFi
{
  ...
  {
    private static readonly LoFi[] NoEffects = new LoFi[0];
    ...
    public static LoFi Instance
    {
      get
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          {
            if (scriptableRendererData.rendererFeatures[i] is LoFi)
              return scriptableRendererData.rendererFeatures[i] as LoFi;
          }
        }
